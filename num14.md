...
>A tree data structure can be defined recursively as a collection of nodes, where each node is a data structure consisting of a value and a list of references to nodes. The start of the tree is the "root node" and the reference nodes are the "children". No reference is duplicated and none points to the root.<br>
Wikipedia


![tree](https://assets.alexandria.raywenderlich.com/books/dsk/images/03e731917c96a3836d7144b50f15027052d4816e63ee0190be8e232d4ff00cfc/original.png)
